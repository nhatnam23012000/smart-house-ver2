...
export default function Livingroom() {
    ...
    const [livingRoomSecurity, setLivingRoomSecurity] = useState(false);
    ...
    const toggleLivingRoomSecurity = () => setLivingRoomSecurity(previousState => !previousState)
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.headerImg}>
                ...
                <Image source={livingroomImg} style={styles.headImage}/>
                ...
                <View style={{position: 'absolute', top: 0, left: 37, right: 0, bottom: 0, justifyContent: 'center'}}>
                    <Text style={styles.headerText}>Living room</Text>
                </View>                    
            </View>
                ...
                <View style={styles.menuBtn1}>
                    ...
                    <View style={{justifyContent: 'space-evenly', flexDirection:'row'}}>
                        ...
                        <Switch
                            trackColor={{ false: "black", true: "#81b0ff" }}
                            thumbColor={'white'}
                            onValueChange={toggleLivingRoomSecurity} 
                            value={livingRoomSecurity}
                        />
                    </View>
                </View>
