...
export default function Bedroom() {
    ...
    const [bedroomSecurity, setBedroomSecurity] = useState(false);
    ...
    const toggleBedroomSecurity = () => setBedroomSecurity(previousState => !previousState)
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.headerImg}>
                ...
                <Image source={bedroomImg} style={styles.headImage}/>
                ...
                <View style={styles.menuBtn1}>
                    ...
                    <View style={{justifyContent: 'space-evenly', flexDirection:'row'}}>
                        ...
                        <Switch
                            trackColor={{ false: "black", true: "#81b0ff" }}
                            thumbColor={'white'}
                            onValueChange={toggleBedroomSecurity} 
                            value={bedroomSecurity}
                        />
                    </View>
                </View>
